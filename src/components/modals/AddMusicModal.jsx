        ...
        <div className="modal-content">
          ...
          {songData && (
            <div className="song-preview">
              <img src={songData.coverImage} alt={songData.trackName} className="preview-cover" />
              <div className="preview-info">
                <h3 className="preview-track">{songData.trackName}</h3>
                <p className="preview-artist">{songData.artistName}</p>
              </div>
            </div>
          )}
