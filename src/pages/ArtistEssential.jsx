            ...
            <div className="music-list">
              {myMusic.map((music) => (
                <div key={music._id} className="music-item">
                  <img src={music.coverImage} alt={music.trackName} className="music-cover" />
  ...
  {(music.genres || []).map((genre, idx) => (
    <span key={idx} className="genre-tag">{genre}</span>
                  ...
                  <div className="music-actions">
                    ...
                    {music.appleMusicLink && (
                      <a href={music.appleMusicLink} target="_blank" rel="noopener noreferrer" className="platform-link">
